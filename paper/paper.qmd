...
author: 
  ...
  - Luca Carnegie
  - Nathalie Moon
thanks: "Code and data are available at: https://github.com/lcarnegie/llms-achievement. We thank attendees at JSM 2024 for helpful suggestions. This research was approved by the University of Toronto's Research Ethics Board (Protocol 47725). Comments: rohan.alexander@utoronto.ca"
date: today
date-format: long
...
`brms` [@brms] package. Our code to adjust for the fact that there were no students who got zero follows @buerkner, @Heiss2021 and @andrewagain. Model diagnostics are included in [Appendix -@sec-model-details]. 
