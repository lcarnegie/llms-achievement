...
#| fig-cap: Causal relationship between song characteristics and hit song before 2020
#| echo: false
#| warning: false
#| message: false
...
## Shiny application 
Accompanying the paper, a Shiny app [@citeshiny] using shinyWidgets [@citeshinyWidgets] and plotly [@citeplotly] was created that contains interactive visualizations. The application can be found here: 

## Acknowledgments 
We would like the acknowledge  for some of the R code used in this paper to produce the tables and graphs.
